...
class Ui_mw_main(object):
    def setupUi(self, mw_main):
        ...
        self.sawc_chart.setGeometry(QtCore.QRect(0, -246, 787, 817))
        self.sawc_chart.setObjectName("sawc_chart")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.sawc_chart)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.gb_curve_editor = QtWidgets.QGroupBox(self.sawc_chart)
        self.gb_curve_editor.setObjectName("gb_curve_editor")
        self.gridLayout_12 = QtWidgets.QGridLayout(self.gb_curve_editor)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.cb_fan_curve_selection = QtWidgets.QComboBox(self.gb_curve_editor)
        self.cb_fan_curve_selection.setEditable(True)
        self.cb_fan_curve_selection.setObjectName("cb_fan_curve_selection")
        self.gridLayout_12.addWidget(self.cb_fan_curve_selection, 0, 0, 1, 1)
        self.f_fan_curve_ph = QtWidgets.QFrame(self.gb_curve_editor)
        ...
        self.gridLayout_12.addWidget(self.f_fan_curve_ph, 1, 0, 1, 1)
        self.gb_fan_curve_options = QtWidgets.QGroupBox(self.gb_curve_editor)
        ...
        self.f_fan_curve_temperature_source = QtWidgets.QFrame(self.gb_fan_curve_options)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.f_fan_curve_temperature_source)
        self.f_pwm_controlled = QtWidgets.QFrame(self.gb_fan_curve_options)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.f_pwm_controlled)
        self.f_fan_options_preset = QtWidgets.QFrame(self.gb_fan_curve_options)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.f_fan_options_preset)
        self.gridLayout_12.addWidget(self.gb_fan_curve_options, 2, 0, 1, 1)
        self.gridLayout_4.addWidget(self.gb_curve_editor, 1, 0, 1, 1)
        ...
        self.tw_led_curve_channel = QtWidgets.QTabWidget(self.gb_led_curve_editor)
        ...
        self.gl_tw_led_channel_ph = QtWidgets.QGridLayout(self.f_tw_led_channel_t_r_ph)
        self.gl_tw_led_channel_ph.setContentsMargins(0, 0, 0, 0)
        self.gl_tw_led_channel_ph.setSpacing(0)
        self.gl_tw_led_channel_ph.setObjectName("gl_tw_led_channel_ph")
        ...
        self.gridLayout_14.addWidget(self.tw_led_curve_channel, 1, 0, 1, 1)
        self.cb_led_curve_selection = QtWidgets.QComboBox(self.gb_led_curve_editor)
        self.cb_led_curve_selection.setEditable(True)
        self.cb_led_curve_selection.setObjectName("cb_led_curve_selection")
        self.gridLayout_14.addWidget(self.cb_led_curve_selection, 0, 0, 1, 1)
        self.gb_led_curve_options = QtWidgets.QGroupBox(self.gb_led_curve_editor)
        ...
        self.f_channel_sync_options = QtWidgets.QFrame(self.gb_led_curve_options)
        ...
        self.gridLayout_16.addWidget(self.f_channel_sync_options, 4, 0, 1, 2)
        self.f_led_curve_temperature = QtWidgets.QFrame(self.gb_led_curve_options)
        ...
        self.gridLayout_16.addWidget(self.f_led_curve_temperature, 2, 0, 1, 2)
        self.f_led_curve_control_selection = QtWidgets.QFrame(self.gb_led_curve_options)
        ...
        self.gridLayout_16.addWidget(self.f_led_curve_control_selection, 1, 0, 1, 2)
        self.f_led_options_preset = QtWidgets.QFrame(self.gb_led_curve_options)
        ...
        self.gridLayout_16.addWidget(self.f_led_options_preset, 0, 0, 1, 2)
        self.gridLayout_14.addWidget(self.gb_led_curve_options, 2, 0, 1, 1)
        self.gridLayout_4.addWidget(self.gb_led_curve_editor, 2, 0, 1, 1)
        ...
        self.cb_temperature_display_selection = QtWidgets.QComboBox(self.gb_temperature_display)
        ...
        self.gridLayout_6.addWidget(self.cb_temperature_display_selection, 1, 0, 1, 1)
        self.f_temperature_display_ph = QtWidgets.QFrame(self.gb_temperature_display)
        ...
        self.gridLayout_6.addWidget(self.f_temperature_display_ph, 2, 0, 1, 1)
        self.gridLayout_4.addWidget(self.gb_temperature_display, 0, 0, 1, 1)
        ...
        self.sawc_fan_status.setGeometry(QtCore.QRect(0, 0, 154, 443))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_11 = QtWidgets.QGridLayout(self.gb_led_preview)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.pb_led_preview = QtWidgets.QPushButton(self.gb_led_preview)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pb_led_preview.sizePolicy().hasHeightForWidth())
        self.pb_led_preview.setSizePolicy(sizePolicy)
        self.pb_led_preview.setObjectName("pb_led_preview")
        self.gridLayout_11.addWidget(self.pb_led_preview, 0, 0, 1, 1)
        ...
        mw_main.setTabOrder(self.sa_chart, self.cb_temperature_display_selection)
        mw_main.setTabOrder(self.cb_temperature_display_selection, self.cb_fan_curve_selection)
        mw_main.setTabOrder(self.cb_fan_curve_selection, self.cb_fan_options_preset)
        ...
        mw_main.setTabOrder(self.cb_pwm_controlled, self.cb_led_curve_selection)
        mw_main.setTabOrder(self.cb_led_curve_selection, self.tw_led_curve_channel)
        mw_main.setTabOrder(self.tw_led_curve_channel, self.cb_led_options_preset)
        ...
        mw_main.setTabOrder(self.pb_led_options_load, self.rb_time_controlled)
        mw_main.setTabOrder(self.rb_time_controlled, self.rb_temperature_controlled)
        mw_main.setTabOrder(self.rb_temperature_controlled, self.cb_led_curve_temperature_source_selection)
        mw_main.setTabOrder(self.cb_led_curve_temperature_source_selection, self.cb_r_channel_sync)
        ...
        mw_main.setTabOrder(self.sa_fan_status, self.pb_led_preview)

    def retranslateUi(self, mw_main):
        _translate = QtCore.QCoreApplication.translate
        mw_main.setWindowTitle(_translate("mw_main", "Leviathan\'s Breath"))
        self.gb_curve_editor.setTitle(_translate("mw_main", "Fan Curve Editor"))
        ...
        self.pb_led_preview.setText(_translate("mw_main", "PushButton"))
