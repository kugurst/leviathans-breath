...
class Ui_mw_main(object):
    def setupUi(self, mw_main):
        ...
        self.sawc_chart.setGeometry(QtCore.QRect(0, -302, 681, 859))
        ...
        self.gl_led_options_anim.addWidget(self.f_led_curve_temperature, 2, 0, 1, 1)
        ...
        self.gl_led_options_anim.addWidget(self.f_led_curve_control_selection, 3, 0, 1, 1)
        ...
        self.gl_led_options_anim.addWidget(self.f_channel_sync_options, 4, 0, 1, 1)
        ...
        self.frame = QtWidgets.QFrame(self.f_led_options_anim)
        ...
        self.dsb_speed_multiplier = QtWidgets.QDoubleSpinBox(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gl_led_options_anim.addWidget(self.frame, 1, 0, 1, 1)
        ...
        self.sawc_fan_status.setGeometry(QtCore.QRect(0, 0, 233, 471))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
