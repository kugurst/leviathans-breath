...
class Ui_mw_main(object):
    def setupUi(self, mw_main):
        ...
        self.sawc_chart.setGeometry(QtCore.QRect(0, -248, 787, 819))
        ...
        self.gb_curve_editor.setCheckable(True)
        ...
        self.gl_sawc_chart.addWidget(self.gb_curve_editor, 1, 0, 1, 1)
        ...
        mw_main.setTabOrder(self.sa_chart, self.cb_fan_curve_selection)
